...
# end
  ...
  deps.num_iter."0.1.40" = {
    num_integer = "0.1.42";
    num_traits = "0.2.11";
    autocfg = "1.0.0";
  };
  deps.num_rational."0.2.3" = {
    num_integer = "0.1.42";
    num_traits = "0.2.11";
    autocfg = "1.0.0";
  };
  ...
  deps.rayon_core."1.7.0" = {
    crossbeam_deque = "0.7.3";
    crossbeam_queue = "0.2.1";
    crossbeam_utils = "0.7.2";
    lazy_static = "1.3.0";
    num_cpus = "1.12.0";
  };
